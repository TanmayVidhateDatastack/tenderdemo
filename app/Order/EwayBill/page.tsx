...
import bonus from "../../Icons/mediumIcons/bonus.svg";
      ...
      content: [
        {
          columnIndex: 0,
          className: "cell",
          content: "Road",    contentType: "number",
        },
        {
          columnIndex: 1,
          className: "cell",
...
const eWayBillData = {
  ...
  fieldA: [
    ...
    { label: "Generated By", value: "07AAA CI122 0M2ZU - IPCA LABORATORIES LTD." },
  ...
  fieldB: [
    { label: "GSTIN of Supplier", value: "07AAA C1122 OM2ZU - IPCA LABORATORIES LTD" },
  ...
  Note:[
    {
          title:"Note*: if any descrepancy in information please try after some time."
    }
  ]
};
...
hasSearch={false}
alignment={"center"}
isSortable={false} isFooterRequired={false}                  
        >
 </DsTableComponent> 
</div>
<div>
...
{eWayBillData.Note.map((Note, index) => (
            <div key={index} className={styles.row}>
              <div className={styles.cell}>
                <div className={styles.column}>
