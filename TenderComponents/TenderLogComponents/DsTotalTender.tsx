...
import { closeContext, createContext, displayContext } from "@/Elements/DsComponents/dsContextHolder/dsContextHolder";
...
const DsTotalTenders: React.FC<TotalTendersProps> = React.memo(({ data }) => {
  ...
  useEffect(() => {
    ...
    console.log("Institutional Count:", institutional, "Corporate Count:", corporate);
    ...
    createContext(
      ...
      <Ds_SummaryCount
        ...
        statusValues={[
    {
      addimage: <Image src={institutionalimg} alt={"Institutional"} width={ 0} height={0} />,
      status: "Institutional",
      value: institutional.toString(),
    },
    {
       addimage : <Image src={corporateimag} alt={"Corporate" }width={0} height={0} />,
      status: "Corporate",
